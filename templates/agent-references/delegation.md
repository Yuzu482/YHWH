...
- For delegated reasoning work through Pi, request `gpt-6-luna` with explicit task-proportional thinking under pi-routing: medium by default, low/high/max when justified and supported.
